...
public enum IndicatorT {
    ...
    desProcess,     // Recognizes and follows engineering design principles
    desPrinciples,  // Proposes solutions to open-ended problems
    openEnded,      // Employs appropriate health and safety considerations
    ideaGeneration, // Determines and employs applicable standards and codes of practice
